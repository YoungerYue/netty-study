...
public class FastThreadLocal<V> {
    ...
    public final V get() {
        ...
        return initialize(threadLocalMap);// 如果是，则调用初始化方法
    }
    ...
    public final void set(V value) {
        if (value != InternalThreadLocalMap.UNSET) {// 如果不是UNSET
            InternalThreadLocalMap threadLocalMap = InternalThreadLocalMap.get();// 获取map
            setKnownNotUnset(threadLocalMap, value);// 新增或者更新值
        } else {
    ...
    private void setKnownNotUnset(InternalThreadLocalMap threadLocalMap, V value) {
        if (threadLocalMap.setIndexedVariable(index, value)) {// index 是当前FastThreadLocal的索引 ，如果是新增，那么这个方法返回 true，如果是修改则返回 false
