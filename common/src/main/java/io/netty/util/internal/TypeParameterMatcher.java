...
public abstract class TypeParameterMatcher {
    ...
    //获取类型参数匹配器
	//会根据传进来得Class对象，判断是哪个类型，从而生成相应的匹配器，如果是Object，就是上面的NOOP ，否则就是ReflectiveMatcher。
	// 这个就是根据类型获取参数类型匹配器，就是用到上面你的UnpaddedInternalThreadLocalMap的typeParameterMatcherGetCache
    ...
    //寻找泛型对应的匹配器
	//首先还是从线程本地变量里获取UnpaddedInternalThreadLocalMap的typeParameterMatcherFindCache，
